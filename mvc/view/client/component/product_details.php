...
<main>
                <article class="top" style = "position: relative;">
                        <div class="product">
                            <div class="imagebig">
                                <?php foreach($image_library as $row_library):?>
                                    <div class="image">
                                        <img src="http://localhost:81/Duanmau/public/img/<?php echo $row_library['image_pro']?>" alt="" onclick="changeImage('<?= $id_img++?>')" id="<?php echo $id++?>" class="image_details">
                                    </div>
                                <?php endforeach;?>
                            </div>
                        </div>
                    <?php foreach($result as $row):?>
                        <div class="avatar">
                                <img src="http://localhost:81/Duanmau/public/img/<?php echo $row['image']?>" alt="" id = "avatar"style="width:320px">
                            </div>
                            ...
                            <div class="content_details">
                                    ...
                                    <?php foreach ($comment as $key => $value): ?>
                                        <div class="comment">
                                            <div class="info">
                                                <div class="user_id">
                                                    <img src="http://localhost:81/Duanmau/public/img/<?= $value['image'] ?>" class="user_image">
                                                </div><br>
