        ...
        <tbody>
            <?php foreach ($_SESSION['Cart'] as $key => $values):?>
                <tr>
                    ...
                    <td><input type="number" value="<?php echo $values['quantity'] ?>" class="update_quantity" name="quantity" data-id="<?php echo $values['id']; ?>"style = "border:1px solid black;"></td>
                    <td><button class = "bnt_delete" data-id="<?php echo $values['id']; ?>">xóa</button></td>
                </tr>
            <?php endforeach; ?>
                <tr>
                    <td colspan="5" class="table-active"><p class = "total" style="margin-left:80%;"></p></td>
                </tr>
                <?php if (!empty($_SESSION['Cart'])): ?>
                    <tr>
                        <td colspan="5" class="table-active"><button type="button" class="btn btn-warning" id="bnt_DH" style="margin-left:80%;">Đặt Hàng</button></td>
                    </tr>
                <?php endif; ?>
        </tbody>
    </table>
